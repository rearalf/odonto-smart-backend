...
export class Init1750440270339 implements MigrationInterface {
  name = 'Init1750440270339';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."person_contact_contact_type_enum" AS ENUM('EMAIL', 'PHONE', 'WHATSAPP', 'TELEGRAM')`,
    );
    await queryRunner.query(
      `CREATE TABLE "person_contact" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "person_id" integer NOT NULL, "contact_value" character varying(255) NOT NULL, "contact_type" "public"."person_contact_contact_type_enum" NOT NULL, CONSTRAINT "PK_1094fd036d694f9949ef1c19e39" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "person" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "first_name" character varying(100) NOT NULL, "middle_name" character varying(100), "last_name" character varying(100) NOT NULL, "profile_picture_name" character varying(255), "profile_picture" character varying(255), "user_id" integer NOT NULL, "person_type_id" integer NOT NULL, CONSTRAINT "REL_5157fa65538cae06e66c922c89" UNIQUE ("user_id"), CONSTRAINT "REL_1711d76c14c9146c23087558bb" UNIQUE ("person_type_id"), CONSTRAINT "PK_5fdaf670315c4b7e70cce85daa3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_role" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "user_id" integer NOT NULL, "role_id" integer NOT NULL, CONSTRAINT "PK_fb2e442d14add3cefbdf33c4561" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "role_permission" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "permission_id" integer NOT NULL, "role_id" integer NOT NULL, CONSTRAINT "PK_96c8f1fd25538d3692024115b47" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "permission" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" character varying(255) NOT NULL, "description" character varying(255) NOT NULL, "label" character varying(255) NOT NULL, CONSTRAINT "UQ_240853a0c3353c25fb12434ad33" UNIQUE ("name"), CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_permission" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "user_id" integer NOT NULL, "permission_id" integer NOT NULL, CONSTRAINT "PK_a7326749e773c740a7104634a77" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."patient_gender_enum" AS ENUM('male', 'female', 'other')`,
    );
    await queryRunner.query(
      `CREATE TABLE "patient" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "birth_date" date NOT NULL, "medical_history" text, "allergic_reactions" text, "current_systematic_treatment" text, "lab_references" text, "complete_odontogram" boolean NOT NULL DEFAULT false, "gender" "public"."patient_gender_enum" NOT NULL, "person_id" integer, CONSTRAINT "REL_b829cf7046dfb9d4e510984e97" UNIQUE ("person_id"), CONSTRAINT "PK_8dfa510bb29ad31ab2139fbfb99" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "doctor_specialty" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "doctor_id" integer NOT NULL, "specialty_id" integer NOT NULL, CONSTRAINT "PK_bb2b1ec7556ecdf92c8b6cc8cf7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "doctor" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "person_id" integer NOT NULL, "specialty_id" integer NOT NULL, "qualification" text, CONSTRAINT "REL_fb38f3d7d38878d734a3fbb562" UNIQUE ("person_id"), CONSTRAINT "PK_ee6bf6c8de78803212c548fcb94" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."appointment_status_enum" AS ENUM('PENDING', 'CONFIRMED', 'COMPLETED', 'CANCELLED')`,
    );
    await queryRunner.query(
      `CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "appointment_date" TIMESTAMP NOT NULL, "reason" character varying(255) NOT NULL, "status" "public"."appointment_status_enum" NOT NULL DEFAULT 'PENDING', "notes" text NOT NULL, "start_time" TIMESTAMP NOT NULL, "end_time" TIMESTAMP NOT NULL, "modified_at" TIMESTAMP, "modification_reason" text, "doctor_id" integer, "patient_id" integer, CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_general_state_enum" AS ENUM('healthy', 'decayed', 'extraction', 'extraction_done', 'missing', 'filling', 'crown', 'root_canal', 'implanted', 'bridge_abutment', 'bridge_pontic')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_palatina_enum" AS ENUM('healthy', 'decay', 'filling', 'crown', 'fracture', 'sealant', 'bridge', 'implant', 'abscess', 'wear', 'erosion', 'stain', 'chipped', 'sensitive')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_distal_enum" AS ENUM('healthy', 'decay', 'filling', 'crown', 'fracture', 'sealant', 'bridge', 'implant', 'abscess', 'wear', 'erosion', 'stain', 'chipped', 'sensitive')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_mesial_enum" AS ENUM('healthy', 'decay', 'filling', 'crown', 'fracture', 'sealant', 'bridge', 'implant', 'abscess', 'wear', 'erosion', 'stain', 'chipped', 'sensitive')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_vestibular_enum" AS ENUM('healthy', 'decay', 'filling', 'crown', 'fracture', 'sealant', 'bridge', 'implant', 'abscess', 'wear', 'erosion', 'stain', 'chipped', 'sensitive')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tooth_oclusal_enum" AS ENUM('healthy', 'decay', 'filling', 'crown', 'fracture', 'sealant', 'bridge', 'implant', 'abscess', 'wear', 'erosion', 'stain', 'chipped', 'sensitive')`,
    );
    await queryRunner.query(
      `CREATE TABLE "tooth" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "tooth_number" integer NOT NULL, "general_state" "public"."tooth_general_state_enum" NOT NULL DEFAULT 'healthy', "palatina" "public"."tooth_palatina_enum" NOT NULL DEFAULT 'healthy', "distal" "public"."tooth_distal_enum" NOT NULL DEFAULT 'healthy', "mesial" "public"."tooth_mesial_enum" NOT NULL DEFAULT 'healthy', "vestibular" "public"."tooth_vestibular_enum" NOT NULL DEFAULT 'healthy', "oclusal" "public"."tooth_oclusal_enum" NOT NULL DEFAULT 'healthy', "odontogram_id" integer, CONSTRAINT "PK_0a71cafc77eae5d19645aff3d63" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."tooth_oclusal_enum"`);
    await queryRunner.query(`DROP TYPE "public"."tooth_vestibular_enum"`);
    await queryRunner.query(`DROP TYPE "public"."tooth_mesial_enum"`);
    await queryRunner.query(`DROP TYPE "public"."tooth_distal_enum"`);
    await queryRunner.query(`DROP TYPE "public"."tooth_palatina_enum"`);
    await queryRunner.query(`DROP TYPE "public"."tooth_general_state_enum"`);
